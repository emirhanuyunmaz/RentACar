...
container.bind<IAuthMiddleware>(INTERFACE_TYPE.AuthMiddlewareInteractor).to(AuthMiddlewareInteractor)
...
router.get("/profile" ,authControl.tokenControl.bind(authControl), controller.onUserProfile.bind(controller) )
