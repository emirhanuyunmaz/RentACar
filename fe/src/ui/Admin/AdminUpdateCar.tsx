...
export default function AdminUpdateCar() {
  ...
  useEffect(() => {
    if (getCar.isSuccess) {
      form.setFields([
        ...
        {
          name: ['airConditioner'],
          value: getCar.data?.data.airConditioner ?? '',
        },
  ...
  const deleteImage = async (imageName: String) => {
    adminDeleteCarImage({ imageName: imageName })
      .unwrap()
      .then((res) => {
        console.log('RES:', res);
      })
  ...
  const handleOk = () => {
    ...
    adminDeleteCar({ id: searchParams.get('id') })
      .unwrap()
      .then((res) => {
        console.log('RES:', res);
        navigate(-1);
  ...
  return (
    <div className="max-w-7xl md:mx-auto min-h-[75vh]">
      <Form
        name="basic"
        layout={'vertical'}
        form={form}
          ...
          <div className="mx-3 flex gap-3">
            {
              <ImageUpload
                ...
                oldFileSize={getCar.data?.data.images.length}
              />
            }

            {getCar.data?.data.images.map((image: any) => (
          ...
          <div className="flex flex-col gap-3 mx-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <Form.Item<FieldType>
                ...
                rules={[
                  {
                    required: true,
                    message: 'Please input car air conditioner!',
                  },
                ]}
                className="w-full"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              ...
              <Form.Item<FieldType>
                ...
                name="distance"
                rules={[
                  { required: true, message: 'Please input car distance!' },
                ]}
              >
