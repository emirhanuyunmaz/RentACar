...
export default function About() {
  return (
    <div className="min-h-[60vh] max-w-7xl mx-auto px-4 md:px-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-4 md:mt-16">
        ...
        <div className="flex flex-col gap-3">
          <div>
            ...
            <p>
              We are a trusted car rental company committed to providing
              reliable, affordable, and convenient transportation solutions to
          ...
          <div>
            ...
            <p>
              ...
              stress-free by offering top-quality vehicles and exceptional
              customer service.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3">
          <div>
            ...
            <p>
              From compact cars to luxury SUVs, we offer a wide range of
              vehicles to suit every travel style and budget, available for
          ...
          <div>
            ...
            <p>
              With transparent pricing, 24/7 customer support, and a hassle-free
              booking process, we ensure a smooth and satisfying rental
      ...
      <div className="grid grid-cols-3 ">
        <div className="flex flex-col gap-1 justify-center items-center">
          ...
          <p className="font-bold text-sm md:text-xl text-center">
            Happy Customers
          </p>
        </div>
        <div className="flex flex-col gap-1 justify-center items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-10">
        <div>
          <h3 className="text-2xl font-bold">
            Your Journey Starts Here: Reliable Car Rental with a Friendly Touch
          </h3>
          <div className="">
            <div className="my-6">
              <p className="">
                We make the car rental process fast, safe, and comfortable with
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-10">
              <div className="flex flex-col gap-3">
                <p>
                  ...
                  Our expert staff is always ready to offer vehicle options
                ...
                <p>
                  ...
                  before every journey to ensure maximum safety.
                </p>
              </div>
              <div className="flex flex-col gap-3">
                <p>
                  ...
                  We prioritize customer satisfaction with affordable prices,
                  flexible rental periods, and an easy booking system.
                </p>
                <p>
                  <span className="me-2">
                    <CheckCircleTwoTone />
                  </span>
                  Our wide range of vehicles provides personalized solutions for
                  both individual and corporate travel needs.
                </p>
              </div>
            </div>
          </div>
